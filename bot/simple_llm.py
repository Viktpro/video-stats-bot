...
class SimpleLLM:
    async def text_to_sql(self, user_query: str) -> str:
        ...
        # 3. Суммарное количество просмотров за месяц (ИСПРАВЛЕНО)
        ...
        # 8. Разные видео с новыми просмотрами
